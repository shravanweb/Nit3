...
import Bg1 from '../components/assets/77.jpg'; // Adjust the path as necessary
...
const Hero = () => {
  ...
  return (
    ...
    >
      {/* Particle background */}
  <img src={Bg1} alt="Background" className="absolute inset-0 w-full h-full object-cover opacity-90 mt-16" style={{ top: '0.9rem' }} />
      <ParticleBackground1 />
      ...
      <div className="absolute bottom-0 left-0 w-full flex flex-col items-center justify-end pb-16 px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <div className="text-xl md:text-1xl text-black mb-2 animate-fadeInUp animation-delay-300">
          ...
          <p className="text-lg text-black-200 mb-4 animate-fadeInUp animation-delay-500 max-w-3xl mx-auto leading-relaxed">
